                ...
                <div class="card">
                  <div class="card-header d-flex col-md-6">
                    ...
                    <div class="col-md-3">
                      ...
                      >
                        <ion-icon name="add-circle-outline"></ion-icon> RETRAIT
                      </router-link>
                    </div>
                  </div>
                        ...
                        >
                          <table class="table table-head-fixed text-nowrap">
                            ...
                            <tbody>
                              ...
                              <tr v-for="(withdrawal, i) in resumWithdrawals" :key="i">
                                <td>{{ i + 1 }}</td>
                                ...
                                <td>
                                  <div class="btn-group">
                                    ...
                                    >
                                      <button
                                        @click="deleteWithdrawal(withdrawal.id)"
                                        type="button"
                                        class="dropdown-item"
                                      >
                                        <ion-icon
                            ...
                            <tfoot>
                              <tr>
                                <th>Total</th>
                                <th v-if="userRole != 1">
                                  {{ formatPrice(withdrawalTotal) }}
                                </th>
                                <th v-if="userRole != 0">
                                  {{ formatPrice(withdrawalTotalByUser) }}
                                </th>
                              </tr>
                            </tfoot>
                          </table>
